...
- 🛠 [Подготовка к запуску](#-требования)
...
- 🚀 [Запуск клиента и сервера PaddleOCR VL + PaddleOCR vLLM (пример из документации)](#-запуск-клиента-и-сервера-paddleocr-vl--paddleocr-vllm)
  - [Запуск](#запуск)
